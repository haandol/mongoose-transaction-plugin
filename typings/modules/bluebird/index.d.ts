...
// Source: https://raw.githubusercontent.com/types/npm-bluebird/48e45988c7275827c137435de0f4f60aebd5c7a0/bluebird.d.ts
...
class Bluebird<R> implements Bluebird.Thenable<R>, Bluebird.Inspection<R> {
   ...
   */
  static using<R, T>(disposer: Bluebird.Disposer<R>, executor: (transaction: R) => void | T | Bluebird.Thenable<T>): Bluebird<T>;
  static using<R1, R2, T>(disposer: Bluebird.Disposer<R1>, disposer2: Bluebird.Disposer<R2>, executor: (transaction1: R1, transaction2: R2) => void | T | Bluebird.Thenable<T>): Bluebird<T>;
  static using<R1, R2, R3, T>(disposer: Bluebird.Disposer<R1>, disposer2: Bluebird.Disposer<R2>, disposer3: Bluebird.Disposer<R3>, executor: (transaction1: R1, transaction2: R2, transaction3: R3) => void | T | Bluebird.Thenable<T>): Bluebird<T>;
